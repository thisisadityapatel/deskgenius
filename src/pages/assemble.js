              ...
              <div className="flex items-center justify-between p-5 border-b rounded-t dark:border-gray-600">
                ...
                <div className="p-6 space-y-6">
                  <div className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                    <p className="text-1xl text-white">DeskGenius is Unavailable on Mobile Devices</p>
                    <p className="text-1xl text-gray-400 flex justify-left">
                      DeskGenius is currently only available for desktop use, offering a rich, immersive experience. If you have any ideas for a mobile version or any other suggestions, please don't hesitate to fork the GitHub repository and submit a pull request for me to review.
                    </p>
                  </div>
                </div></>:<>
                <div className="p-6 space-y-6">
