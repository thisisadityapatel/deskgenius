...
const DeskMenu = ({modelName, modelTitle, changeTable}) => {
  return (
      <div className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl dark:border-gray-700 dark:bg-gray-800 mb-5">
          ...
          <div className="flex flex-col justify-between p-2 leading-normal">
              <div className="mb-2 font-bold tracking-tight text-gray-900 dark:text-white">{modelTitle}</div>
              <p className="mb-2 font-normal text-gray-700 dark:text-gray-400">Testing description</p>
